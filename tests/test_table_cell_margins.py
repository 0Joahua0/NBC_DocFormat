...
def test_table_cell_margin_defaults_and_custom_values_round_trip(tmp_path, monkeypatch):
    defaults = nbc_docformat.DEFAULT_CUSTOM_SETTINGS["table"]
    ...
    preset = deepcopy(nbc_docformat.DEFAULT_CUSTOM_SETTINGS)
    ...
    loaded = nbc_docformat.get_active_user_preset(nbc_docformat.load_custom_settings())
